...
S1-Orange 是一个为 HarmonyOS Next 开发的 [stage1st.com](https://stage1st.com/) 论坛第三方客户端，使用 **ArkTS**（ArkUI 的 TS 方言，强制静态类型）与 stage 模型。最低 SDK 版本 16，target SDK 版本 16。无后端，所有数据来自论坛 web/app 接口或本地存储。
